...
public class SABS {
    public static void main(String[] args) {
        ...
        Repositorio.usuarios.agregar(new Usuario("user2", "123456"));
        Repositorio.usuarios.agregar(new Usuario("user3", "12345"));
        Repositorio.usuarios.agregar(new Administrador("admin3", "3333"));
        Repositorio.usuarios.agregar(new Administrador("admin4", "4444"));
        Repositorio.usuarios.agregar(new Administrador("admin5", "5555"));
        Repositorio.usuarios.agregar(new Usuario("user4", "1234567"));
